...
# BPE
codes_hi_bn_ju_hi = codecs.open("bpe-codes/codes.hi", encoding='utf-8')
bpe_hi_bn_ju_hi = BPE(codes_hi_bn_ju_hi)

# Translator
translator_hibn_ju = ctranslate2.Translator("model_deploy/",
    # compute_type="int8",
...
# Apply BPE
inp_lines = [bpe_hi_bn_ju_hi.process_line(line).split(" ") for line in inp_lines]

# Translate
out_lines = translator_hibn_ju.translate_batch(inp_lines, beam_size=5, max_batch_size=16)
