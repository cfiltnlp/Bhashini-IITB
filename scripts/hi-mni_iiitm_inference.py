...
# BPE
codes_hi_mni_hi_codes = codecs.open("codes/codes.hi", encoding='utf-8')
bpe_hi_mni_hi_bpe = BPE(codes_hi_mni_hi_codes)

# Translator
translator_hi_mni = ctranslate2.Translator("translator_ct/",
    # compute_type="int8",
...
# Apply BPE
inp_lines = [bpe_hi_mni_hi_bpe.process_line(line).split(" ") for line in inp_lines]

# Translate
out_lines = translator_hi_mni.translate_batch(inp_lines, beam_size=5, max_batch_size=16)
