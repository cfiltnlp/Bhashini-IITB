...
# BPE
codes_en_bodo_en_codes = codecs.open("bpe-codes/eng_code.txt", encoding='utf-8')
bpe_en_bodo_en_bpe = BPE(codes_en_bodo_en_codes)

# Translator
translator_en_bodo = ctranslate2.Translator("model_deploy/",
    # compute_type="int8",
...
# Apply BPE
inp_lines = [bpe_en_bodo_en_bpe.process_line(line).split(" ") for line in inp_lines]

# Translate
out_lines = translator_en_bodo.translate_batch(inp_lines, beam_size=5, max_batch_size=16)
